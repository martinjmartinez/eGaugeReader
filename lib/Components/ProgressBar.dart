...
class ProgressBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    double percentageWidth =
        (this.numerator.abs() / this.denominator.abs()) * barWithoutPadding;
    double displayPercentage =
        (this.numerator.abs() / this.denominator.abs()) * 100;
            ...
            children: <Widget>[
              new Row(
                ...
                children: <Widget>[
                  ...
                  showValues
                      ? new Text(
                          this.numerator.abs().toStringAsFixed(1) +
                              ' / ' +
                              this.denominator.abs().toStringAsFixed(1),
                          style: this.titleStyle)
                      : new Text(
                          this.numerator.abs().toStringAsFixed(1) + ' kWh',
                          style: this.titleStyle)
                ],
              ),
              new SizedBox(
